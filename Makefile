...
srcroot := 
objroot := 
abs_srcroot := /cygdrive/g/Project/OpenSrc/MemoryPool/jemalloc-3.6.0/jemalloc-3.6.0/
abs_objroot := /cygdrive/g/Project/OpenSrc/MemoryPool/jemalloc-3.6.0/jemalloc-3.6.0/

# Build parameters.
CPPFLAGS :=  -D_REENTRANT -I$(srcroot)include -I$(objroot)include
